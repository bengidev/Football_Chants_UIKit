...
class TeamViewModel {
    ...
    private(set) var teams: [Team] = [
        Team(teamType: .arsenal,
             ...
             founded: "October 1886", teamLeader: .init(name: "Mikel Arteta", job: .manager)),
        Team(teamType: .astonVilla,
             name: "Aston Villa",
             ...
             founded: "November 1874", teamLeader: .init(name: "Dean Smith", job: .headCoach)),
        Team(teamType: .brighton,
             name: "Brighton",
             ...
             founded: "June 1901", teamLeader: .init(name: "Graham Potter", job: .headCoach)),
        Team(teamType: .burnley,
             name: "Burnley",
             ...
             founded: "May 1882", teamLeader: .init(name: "Sean Dyche", job: .manager)),
        Team(teamType: .chelsea,
             name: "Chelsea",
             ...
             founded: "March 1905", teamLeader: .init(name: "Frank Lampard", job: .headCoach)),
        Team(teamType: .everton,
             name: "Everton",
             ...
             founded: "1878", teamLeader: .init(name: "Carlo Ancelotti", job: .manager)),
        Team(teamType: .fulham,
             name: "Fulham",
             ...
             founded: "1879", teamLeader: .init(name: "Scott Parker", job: .headCoach)),
        Team(teamType: .leeds,
             name: "Leeds",
             ...
             founded: "October 1919", teamLeader: .init(name: "Marcelo Bielsa", job: .headCoach)),
        Team(teamType: .leicester,
             name: "Leicester",
             ...
             founded: "1884", teamLeader: .init(name: "Brendan Rodgers", job: .manager)),
        Team(teamType: .liverpool,
             name: "Liverpool",
             ...
             founded: "June 1892", teamLeader: .init(name: "Jürgen Klopp", job: .manager)),
        Team(teamType: .manchesterCity,
             ...
             founded: "1880", teamLeader: .init(name: "Pep Guardiola", job: .manager)),
        Team(teamType: .manchesterUnited,
             ...
             founded: "1902", teamLeader: .init(name: "Ole Gunnar Solskjær", job: .manager)),
        Team(teamType: .newcastle,
             ...
             founded: "December 1892", teamLeader: .init(name: "Steve Bruce", job: .manager)),
        Team(teamType: .palace,
             name: "Crystal Palace",
             ...
             founded: "September 1905", teamLeader: .init(name: "Roy Hodgson", job: .manager)),
        Team(teamType: .sheffield,
             ...
             founded: "March 1889", teamLeader: .init(name: "Chris Wilder", job: .manager)),
        Team(teamType: .southampton,
             name: "Southampton",
             ...
             founded: "November 1885", teamLeader: .init(name: "Ralph Hasenhüttl", job: .manager)),
        Team(teamType: .tottenham,
             ...
             founded: "September 1882", teamLeader: .init(name: "José Mourinho", job: .manager)),
        Team(teamType: .westBrom,
             name: "West Brom",
             ...
             founded: "1878", teamLeader: .init(name: "Slaven Bilić", job: .manager)),
        Team(teamType: .wolves,
             name: "Wolves",
